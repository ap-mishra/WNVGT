...
# Backfitting
backfitting = gnb.predict_proba(train)[:,1]
...
print 'Printing ROC FPR and TPR'
fpr, tpr, thresholds = roc_curve(labels, backfitting)
print fpr
print tpr

print 'Printing ROC Accuracy score'
accuracy_score = roc_auc_score(labels, backfitting, average ='macro')
